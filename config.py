...
class Config:
    ...
    # Lemon Squeezy billing (Merchant of Record — trabaja desde Colombia)
    LEMONSQUEEZY_API_KEY = os.environ.get("LEMONSQUEEZY_API_KEY", "")
    LEMONSQUEEZY_WEBHOOK_SECRET = os.environ.get("LEMONSQUEEZY_WEBHOOK_SECRET", "")
    LEMONSQUEEZY_STORE_ID = os.environ.get("LEMONSQUEEZY_STORE_ID", "")
    LEMONSQUEEZY_VARIANT_BASIC_MONTHLY = os.environ.get("LEMONSQUEEZY_VARIANT_BASIC_MONTHLY", "")
    LEMONSQUEEZY_VARIANT_BASIC_ANNUAL = os.environ.get("LEMONSQUEEZY_VARIANT_BASIC_ANNUAL", "")
    LEMONSQUEEZY_VARIANT_STANDARD_MONTHLY = os.environ.get("LEMONSQUEEZY_VARIANT_STANDARD_MONTHLY", "")
    LEMONSQUEEZY_VARIANT_STANDARD_ANNUAL = os.environ.get("LEMONSQUEEZY_VARIANT_STANDARD_ANNUAL", "")
    LEMONSQUEEZY_VARIANT_PRO_MONTHLY = os.environ.get("LEMONSQUEEZY_VARIANT_PRO_MONTHLY", "")
    LEMONSQUEEZY_VARIANT_PRO_ANNUAL = os.environ.get("LEMONSQUEEZY_VARIANT_PRO_ANNUAL", "")
