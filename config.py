...
class Config:
    ...
    # Polar.sh billing (Merchant of Record — persona natural Colombia)
    POLAR_ACCESS_TOKEN = os.environ.get("POLAR_ACCESS_TOKEN", "")
    POLAR_WEBHOOK_SECRET = os.environ.get("POLAR_WEBHOOK_SECRET", "")
    POLAR_ORGANIZATION_ID = os.environ.get("POLAR_ORGANIZATION_ID", "")
    POLAR_PRODUCT_BASIC_MONTHLY = os.environ.get("POLAR_PRODUCT_BASIC_MONTHLY", "")
    POLAR_PRODUCT_BASIC_ANNUAL = os.environ.get("POLAR_PRODUCT_BASIC_ANNUAL", "")
    POLAR_PRODUCT_STANDARD_MONTHLY = os.environ.get("POLAR_PRODUCT_STANDARD_MONTHLY", "")
    POLAR_PRODUCT_STANDARD_ANNUAL = os.environ.get("POLAR_PRODUCT_STANDARD_ANNUAL", "")
    POLAR_PRODUCT_PRO_MONTHLY = os.environ.get("POLAR_PRODUCT_PRO_MONTHLY", "")
    POLAR_PRODUCT_PRO_ANNUAL = os.environ.get("POLAR_PRODUCT_PRO_ANNUAL", "")
